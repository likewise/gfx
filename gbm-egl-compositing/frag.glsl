...
void main()
{
  ...
  // texel colour is non-premultiplied (from PNG RGBA), multiply colour it with its own alpha
  texCol *= vec3(texel.a);
  ...
  // texCol and vtxCol contain pre-multiplied rgb
  ...
  // Porter-Duff Over, alpha is coverage
  // as = alpha source
